function prepopulateValues(occType, billingData, appliancesCount) {
        ...
        document.getElementById('edit-payment-occupancyType').value = occType.occRate;
        
        document.getElementById('edit-noOfAppliances').value = appliancesCount.count;
  
        document.getElementById('edit-dummy-create-billing-billTotal').value = parseInt(occType.occRate) + parseInt(appliancesCount.count * 100);
