function prepopulateValues(payment, billingData, prepBool) {
  if (prepBool == 1) {
    ...
    document.getElementById("editBillDateIssued").value =
      billingData.billDateIssued;

    document.getElementById("editBillDueDate").value = billingData.billDueDate;
    document.getElementById("editBillDueDateDummy").value =
      billingData.billDueDate;

    document.getElementById("edit-create-billing-billTotal").value =
      billingData.billTotal;
  } else {
    ...
    document.getElementById("editPaidBillDueDate").value =
      billingData.billDueDate;
