...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const initialDisplayStates = Array.from(roomInfo).map(
    (room) => window.getComputedStyle(room).display
  );
  ...
  showAvailRmBtn.addEventListener("click", () => {
    ...
    showAvailRmBtn.textContent =
      visibleRoomsCount === roomInfo.length
  ...
  document
    .getElementById("edit-rent-start")
